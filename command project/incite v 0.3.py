...
def test():
    testvar = datetime.today()
    print("hi")
    testvar2 = datetime.today()

    endprint = testvar2 - testvar
    print("this process took ", endprint)
...
def welcome():
    ...
    print(" ")
    print(" ")
    print(Fore.LIGHTRED_EX + "Python based Command Prompt [Version 0.3]")
    print(Fore.LIGHTRED_EX + "Copyright 2020, lubnc4261, All rights reserved.")
    print(Fore.LIGHTGREEN_EX + "---------------------------------------------------")
    print(Fore.YELLOW + __file__)
    print(Fore.LIGHTGREEN_EX + "---------------------------------------------------")
    ...
    print(" ")
    print("--- %s seconds to load the programm ---" % (time.time() - start_time))
    start()
